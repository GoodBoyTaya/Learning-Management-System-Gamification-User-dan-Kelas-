    ...
    <main>
      ...
      switch ($nav) {
        ...
        case 'superadmin_admindata':
          ...
          $userController->DaftarAdmin();
          break;
        case 'superadmin_adminadd':
          $userController = new UserController();
          $userController->addAdmin();
          break;
        case 'superadmin_adminedit':
          $userController = new UserController();
          $userController->editAdmin();
          break;
        case 'superadmin_admindelete':
          $userController = new UserController();
          $userController->DeleteAdmin();
          break;
        case 'superadmin_schooldata':
          $sekolahController = new SekolahController();
          $sekolahController->getsekolah();
          break;
        case 'superadmin_schooladd':
          $sekolahController = new SekolahController();
          $sekolahController->addSekolah();
          break;
        case 'superadmin_schooledit':
          $sekolahController = new SekolahController();
          $sekolahController->editSekolah();
          break;
        case 'keluar':
          $userController = new UserController();
          $userController->Logoutsu();
          break;
        default:
          if ($_SESSION['session']) {
            if ($_SESSION['status'] == 1) {
              include_once './views/superadmin/superadminlanding.php';
            }
            else{
            }
          }
