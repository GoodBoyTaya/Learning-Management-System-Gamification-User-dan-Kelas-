    ...
    <div class="probootstrap-page-wrapper">
      ...
      <section class="probootstrap-section probootstrap-animate">
        <div class="container">
          <div class="row">
            <div class="col-sm-12">              
              <a class="btn btn-success" href="?navito=admin_studentadd"><i class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;&nbsp; Tambah Data</a>
            </div>
          </div>
          <br>     
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td style="max-width: 150px;"><a class="btn btn-warning" href="?navito=admin_studentedit&id=<?php echo $row['id']?>"><i class="glyphicon glyphicon-pencil"></i>&nbsp;&nbsp;Edit Data</a>
                    <a class="btn btn-danger" onclick='confirmationDelete($(this));return false;' href="?navito=admin_studentdelete&id=<?php echo $row['id']?>"><i class="glyphicon glyphicon-remove"></i>&nbsp;&nbsp;Hapus Data</a></td>
                  </tr>
                <?php
                  }
                ?>
