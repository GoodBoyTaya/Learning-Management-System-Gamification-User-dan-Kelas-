    ...
    <div class="probootstrap-page-wrapper">
      ...
      <section class="probootstrap-section probootstrap-animate">
        <div class="container">
          <div class="col-sm 2">
              <h4>Kelas &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp; <span style="font-weight: bold;"> <?php echo($selectedschedule[0]['deskripsi']) ?></span></h4>
              <h4>Nama Guru &nbsp;:&nbsp;<span style="font-weight: bold;"> <?php echo($selectedschedule[0]['namaguru']) ?></span> </h4>
              <h4>Nama Mapel :&nbsp;<span style="font-weight: bold;"> <?php echo($selectedschedule[0]['namamapel']) ?></span> </h4>
          </div>
          <br>
          <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal" >
            <div class="form-group form-group-lg">
              ...
              <div class="col-sm-4">
                <select class="form-control" name="selday" id="sel1">
            ...
            <div class="form-group form-group-lg">
              ...
              <div class="col-sm-4">
                <div class='input-group date' id='inputjammasuk'>
                  <input type='text' class="form-control" name="inputjammasuk" value="<?php echo($selectedschedule[0]['jam_mulai']) ?>" required autocomplete="off"/>
            ...
            <div class="form-group form-group-lg">
              ...
              <div class="col-sm-4">
                <div class='input-group date' id='inputjamkeluar'>
                  <input type='text' class="form-control" name="inputjamkeluar" value="<?php echo($selectedschedule[0]['jam_selesai']) ?>" required autocomplete="off"/>
                  <span class="input-group-addon" style="cursor: pointer;">
                  <span class="glyphicon glyphicon-time"></span>
                  </span>
                </div>
